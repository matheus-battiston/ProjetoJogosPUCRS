...
var ComecarSelecionado = "[color=#FF0000]Começar[/color]"
var SairSelecionado = "[color=#FF0000]Sair[/color]"
var InstrucSelecionado = "[color=#FF0000]Instruções[/color]"

var ComecarNaoSelecionado = "[color=#FFFFFF]Começar[/color]"
var SairNaoSelecionado = "[color=#FFFFFF]Sair[/color]"
var InstrucNaoSelecionado = "[color=#FFFFFF]Instruções[/color]"
...
func _process(delta: float) -> void:
	...
	if up:
		...
		if selected == 1:
			...
			get_tree().change_scene("res://Menu/Instruc.tscn")
		elif selected == 3:
			get_tree().quit()
